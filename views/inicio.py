...
st.title("Hemerograph: revistas culturales y literarias")
st.header("⚙️ Configuración de datos para el análisis")
        ...
        if 'Colaborador' not in df_initial_for_bio.columns:
            ...
            with st.spinner("Cargando y fusionando datos biográficos..."):
                try:
                    ...
                    st.subheader(f"Colaboradores identificados con datos biográficos")
                    ...
                    st.subheader(f"Colaboradores NO identificados y sin datos biográficos")
